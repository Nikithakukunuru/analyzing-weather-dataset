...
# You have a temperature data and wanted to convert celsius temperature into fahrehheit temperatures you can call the function convert.#Importing the modules
import pandas as pd
import numpy as np
from scipy.stats import mode 
